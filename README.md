1--"Write a function leggi_array that reads a natural number N (0 ≤ N ≤ 20) from standard input followed by N integers, and stores these numbers in an array (which is received as input)."
